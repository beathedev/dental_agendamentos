...
$sql_codrotav = "SELECT * from agend where dataentrega='$dataentrega' and FK_codrotav='$PK_codrotav' and  FK_coduser = '$PK_coduser' or FK_coduser=15 or FK_coduser=23";
...
/*$sql_codrotava = "SELECT * from agend where FK_codrotav='$PK_codrotav' and FK_codrotinha = '$FK_codrotinha'";
    ...
    echo $num_agends_rotinha;
    


    if($num_agends_rotinha <= 0  or $FK_codrotinha == NULL){ echo ""; }
...
$num_agends_rotinha = mysqli_num_rows($query_rotava);
    ...
    if($num_agends_rotinha <= 0  or $FK_codrotinha == NULL){ echo "nao tem"; }
    elseif( $num_agends_rotinha > 0){ 
    //desce camada 2
