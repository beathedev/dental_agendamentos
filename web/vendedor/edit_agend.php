...
$selectt =mysqli_query($conexao, "SELECT * from agend where PK_codagend='$PK_codrotav'");
...
$sql_atualiza = "UPDATE agend set obs='$obs', volume='$volume', dataabertura='$dataabertura', dataentrega='$dataentrega', cliente='$cliente', endereco='$endereco', bairro='$bairro', status='$status', almoco='$almoco', outros='$outros' WHERE dataentrega = '$dataentrega' and PK_codagend =  '$PK_codagend'  ";
