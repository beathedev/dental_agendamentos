...
<form action="agendamento_rotinha.php" method="POST">
...
echo'
<INPUT type="hidden" name="rotinha_existe" value="rotinha">
<h5 name='.$nomerota.'>'.$nomerota.' <input type="radio" name="areast" 
