...
<table class="greyGridTable" > <?php

$alterar = $_POST['alterar'];
$implode = implode(',', $alterar);
$conta = count($alterar);
...
echo '<form action="edit_agend_admin.php"  method="GET" id="form">

<input type="text" value="'.$implode.'" name="alterar">
