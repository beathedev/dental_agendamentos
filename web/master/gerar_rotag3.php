...
echo'<input type="date" name="data_rota" value="'.$data_rota.'" readonly/><br><br>';
...
//Select agendamentos
        ...
        $sql3 = "SELECT * from agend WHERE FK_codrotav = '$PK_codrotav' ORDER BY bairro desc";  //puxando agendamentos dessas rotas de vendedores
...
header("Location: gerar_rotag3.php?data_rota=".$data_rota);
...
if($entregadorA == "Escolher Entregador" ||( $turnoA == NULL )){
...
elseif($cont == 0){
  $update_ins1 = mysqli_query($conexao, "UPDATE rotavend SET transporte = '$transporteA', turno ='$turnoA' WHERE PK_codrotav = '$PK_codrotava_'");
