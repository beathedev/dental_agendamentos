...
<input type="submit" name="alterarbt"  value="Alterar" class="btn btn-default" onclick="altera_form();"> &nbsp;&nbsp;
...
echo'</td>
<td>
<input type="hidden" style="width:138px;height:90px;" name="obs" readonly value="'.$obs.'"/>';echo $obs; 
echo'</td>
<td>
