...
<br>  <!-- F Nome do cliente -->
    ...
    <br>
     <div class="checkbox">
    <label>
      <input type="checkbox" name="obs[]" checked="false" value="notafiscal"> Nota Fiscal     
    </label>
  </div>
  <div class="checkbox">
    <label>
      <input type="checkbox" name="obs[]" checked="false" value="boleto"> Boleto
    </label>
  </div>
  <div class="checkbox">
    <label>
      <input type="checkbox" name="obs[]" checked="false" value="entrega"> Entrega
    </label>
  </div>
...
$sql_inserir = "INSERT into agend(FK_coduser, FK_codrotav, dataabertura, dataentrega, cliente, endereco, bairro, volume, obs, FK_codrotinha, almoco, autorizado) VALUES ('$cod_vendedorA','$FK_codrotav', '$dataabertura', '$dataentrega','$nomecli', '$endereco', '$bairro', '$volume', '$itens', '$FK_codrotinha', '$hrt', 'Sim')";
...
$status = 1;
$sql_inserir = "INSERT into agend(FK_coduser, FK_codrotav, status, dataabertura, dataentrega, volume, cliente, obs, endereco, bairro, almoco, autorizado) VALUES ('$cod_vendedorA','$FK_codrotav','$status', '$dataabertura', '$dataentrega', '$volume', '$nomecli', '$itens' , '$endereco', '$bairro', '$hrt', 'Sim')";
