...
<br>  <!-- F Nome do cliente -->
    ...
    <br>
     <div class="checkbox">
    <label>
      <input type="checkbox" name="obs[]" checked="true" value="notafiscal"> Nota Fiscal     
    </label>
  </div>
  <div class="checkbox">
    <label>
      <input type="checkbox" name="obs[]" checked="true" value="boleto"> Boleto
    </label>
  </div>
  <div class="checkbox">
    <label>
      <input type="checkbox" name="obs[]" checked="true" value="entrega"> Entrega
    </label>
  </div>
...
$sql_inserir = "INSERT into agend(FK_coduser, FK_codrotav, dataabertura, dataentrega, cliente, endereco, bairro, volume, obs, FK_codrotinha, almoco) VALUES ('$FK_coduser','$FK_codrotav', '$dataabertura', '$dataentrega','$nomecli', '$endereco', '$bairro', '$volume', '$itens', '$FK_codrotinha', '$hrt')";
...
$status = 1;
$sql_inserir = "INSERT into agend(FK_coduser, FK_codrotav, status, dataabertura, dataentrega, volume, cliente, obs, endereco, bairro, almoco) VALUES ('$FK_coduser','$FK_codrotav','$status', '$dataabertura', '$dataentrega', '$volume', '$nomecli', '$itens' , '$endereco', '$bairro', '$hrt')";
...
$descricao = "criou um agendamento: - Cliente: ".$cliente." - Vendedor: ".$vendedor." - Endereço: ".$endereco." - Bairro: ".$bairro." - Obs: ".$obs."  Data de Entrega: ".$data_." - Status: ".$status." - Volume: ".$volume;
