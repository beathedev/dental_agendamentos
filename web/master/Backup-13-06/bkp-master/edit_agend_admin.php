...
$sql_atualiza = "UPDATE agend set obs='$obs', volume='$volume', dataabertura='$dataabertura', dataentrega='$dataentrega', cliente='$cliente', endereco='$endereco', bairro='$bairro', status='$status' WHERE dataentrega = '$dataentrega' and PK_codagend =  '$PK_codagend'  ";
