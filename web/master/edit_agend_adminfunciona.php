...
$vendedor_ = "SELECT FK_coduser from agend where PK_codagend = '$PK_codagend'";
...
$codvendedor_2 = $recebe_vendedor['FK_coduser'];}

$vendedora_ = "SELECT username from usuario where PK_coduser = '$codvendedor_2'";
$query_vendedora_ = mysqli_query($conexao, $vendedora_);
//Procura se existe nome de vendedor na rota:
while($recebe_vendedora = mysqli_fetch_assoc($query_vendedora_)){
$vendedor_2 = $recebe_vendedora['username'];}
...
$sql_atualiza = "UPDATE agend set FK_coduser='$cod_vendedorA',obs='$obs', volume='$volume', dataabertura='$dataabertura', dataentrega='$dataentrega', cliente='$cliente', endereco='$endereco', bairro='$bairro', status='$status' WHERE dataentrega = '$dataentrega' and PK_codagend =  '$PK_codagend'  ";
