...
echo ' <button type="button" style="width:140px;" name="view" id="'.$codarea.','.$PK_nomerota.'" class="btn btn-info btn-sm view_data4" >
 Ativar por periodo
 </button><br>';
echo'
...
//aqui insere o periodo - editado 18/06 - questionar a fabio dps
$insert2 = mysqli_query($conexao, "INSERT INTO area_bloq(FK_nomerota,data,periodo, inidate, fimdate, status) VALUES ('$FK_nomerota','$arraya[$i]','$periodo', '$inidate', '$fimdate', 0)");
...
echo '</form></div>';
echo'<a href="lista_area.php" class=" btn btn-primary">Não</a>';
