...
<form action="escolher_rota.php" method="POST">
...
<input type="hidden" value="'.$codigos.'" name="codigos_">
<input type="hidden" name="PK_codrotinha[]" value="'.$PK_codrotinha.','.$dataentrega.'"/> '; // <!-- array ou nn -->
echo'
