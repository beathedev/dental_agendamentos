...
header("Location: gerar_rotag2.php?data_rota=".$data_rota);
...
$insert_novarota_ = "INSERT INTO rotavend(FK_datarg, FK_nomerota, quantidadeagend, bloqueado, limiteagend, turno, tipo, entregador) VALUES('$FK_datarg', '$FK_nomerota_', '1', '0', '7', '$turnoA', 'tarde','$entregadorA')";
