...
$sql_data = mysqli_query($conexao, "SELECT * from datas_bloq WHERE PK_databloq = '$dataentrega'");
...
echo'<center>';
echo'
<p>A rota desse dia foi bloqueada. 
<br>Rotinha Disponível:</p>';
echo'<form action="index_admin_rotinha_criar.php" method="POST">';
...
$sql_consulta = "SELECT * from rotavend where  FK_datarg = '$dataentrega' 
					and FK_nomerota ='$pknm[$io]' ORDER BY FK_nomerota ASC";
...
';
if($nomerota[$io] == "bangu" ||($nomerota[$io]  == "bangu2")){
  echo $turno;
}
...
$sql_inseree = "INSERT INTO rotavend(FK_datarg, FK_nomerota) VALUES ('$dataentrega', '$PK_nomerota2')";
