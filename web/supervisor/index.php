...
?>
       ...
       <form action="result_index.php" method="POST" readonly>
...
<?php
ECHO '<input type="hidden" class="form-control" id="exampleInputEmail1" name="data"  style="width:132px;font-size:12px;" value="'.$data_rota.'" readonly>';
$aumenta = 0;
