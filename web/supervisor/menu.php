...
include_once('../supervisor/rotinha_pop.php');
?>
...
<div class="clearfix">
    ...
    <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="lista_agend.php" class=" hvr-bounce-to-right"><i class="fa fa-dashboard nav_icon "></i><span class="nav-label">Agendamentos</span> </a>
                    </li>
                    <li>
                            <a href="lista_area.php" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Áreas</span> </a>
                    </li>
                    <li>
