...
<input type="hidden" value="'.$PK_coduser.'" name="PK_coduser">
  <div class="form-group">
    <label for="exampleInputEmail1">Nome do Usuário</label>
    <input type="text" name="username" class="form-control" id="exampleInputEmail1" placeholder="" value="'.$username.'">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Senha do Usuário</label>
    <input type="text" name="senha" class="form-control" id="exampleInputPassword1" placeholder="" value="'.$senha.'">
  </div>
<div class="form-group">
	<div class="col-sm">
